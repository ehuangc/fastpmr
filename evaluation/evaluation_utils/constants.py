...
AADR_DATA_PREFIX = AADR_DIR / "data" / "v66.p1.1240k.aadr"
AADR_EXTS = (".anno", ".ind", ".snp", ".geno")
AADR_RUNS = 1
AADR_NPZ_PATH = AADR_DIR / "results" / "fastpmr" / "fastpmr_results.npz"
AADR_METADATA_PATH = AADR_DIR / "data" / "v66.p1.1240k.aadr.anno"
...
CHICHEN_ITZA_EAGER_OUTPUTS_DIR = CHICHEN_ITZA_DIR / "eager_outputs"
