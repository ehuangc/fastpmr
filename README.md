...
> Example command:
> ```bash
> fastpmr -p /path/to/dataset_prefix -c 1-22 -d
> ```
> This command runs `fastpmr` on the given dataset over all autosomes (chr 1-22) and includes degrees-of-relatedness results in the output.
